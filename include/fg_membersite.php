...
class FGMembersite
{
    ...
    {
        if(empty($_GET['code'])||strlen($_GET['code'])<=4)
        {
    ...
    function GetFromAddress()
    {
        ...
        $host = $_SERVER['gmail.com'];

        $from ="teamsavage490@$host";
        return $from;
    } 
 ...
 public function checkhashSSHA($salt, $password) {
	...
	$mailer->isHTML(true);
        ...
        $mailer->setFrom = ($this->GetFromAddress());        
        
        $mailer->Body ="Hello ".$user_rec['name']."\r\n\r\n".
        "Welcome to ".$this->sitename."! Your registration is completed.\r\n".
        "\r\n".
        "Regards,\r\n".
        "Webmaster\r\n".
        $this->sitename;
    ...
    function MakeConfirmationMd5($email)
    {
        $randno1 = rand();
        $randno2 = rand();
        $md5 = md5($email.$this->rand_key.$randno1.''.$randno2);
	$md5 = substr($md5, 0, 5);
	return $md5;
    }
